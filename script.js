...
function generateQuestion() {
  ...
  currentAnswer = randomTabuada + num2; // Alterado para adição
  questionContainer.innerHTML = `<br><span class="question-math">Pergunta:<br>${randomTabuada} + ${num2} = ?</span>`; // Alterado para adição
}
